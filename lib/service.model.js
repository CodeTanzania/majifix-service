...
const AUTOPOPULATE_MAX_DEPTH = schema.POPULATION_MAX_DEPTH;
...
const ServiceSchema = new Schema({
  /**
   * @name jurisdiction
   * @description A jurisdiction under which a service (request type) is
   * applicable.
   *
...
ServiceSchema.methods.beforePost = function beforePost(done) {
  //TODO
  //1...ensure default priority if not set
  //2...ensure jurisdiction from service group
  done();
};
